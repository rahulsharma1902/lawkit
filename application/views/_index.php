...
<html class="h-100">
  <head>
    ...
    <meta name="author" content="Ricardo Escobedo, Eduardo Avila">
    <title>Lawkit</title>

    <link href="<?=base_url();?>assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?=base_url();?>assets/css/style-landing.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css2?family=PT+Sans:wght@700&display=swap" > 
    <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=PT+Sans" />
    
    <!-- Custom styles for this template -->
    <link href="<?=base_url();?>assets/css/styles.css" rel="stylesheet">
  </head>
  <body class="d-flex flex-column h-100" style="font-family: PT Sans;">
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse" id="navbarsExample03">
            ...
            <ul class="navbar-nav mb-2 mb-sm-0">
              <li class="nav-item">
                <a class="nav-link text-white" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal">Contáctanos</a>
              </li>
            </ul>
            ...
            <form class="dropdown" role="search"  style="margin-right:65px;">
                <a class="nav-link dropdown-toggle text-white" style="cursor: pointer;" data-bs-toggle="dropdown" aria-expanded="false"><?=$this->session->userdata('fname') . " " . $this->session->userdata('lname');?></a>
            
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?=base_url();?>account/dashboard">Dashboard</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="<?=base_url();?>account/logout">Cerrar Sesión</a></li>
                </ul>
            </form>
            <?php endif; ?>
            </ul><?php if ($this->session->userdata("uid") == NULL):?>
            <form role="search">
                
                <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                  <li class="nav-item">
                    <a class="nav-link text-white" href="<?=base_url();?>account/signin">Iniciar Sesión</a>
                  <li class="nav-item">
                    <a class="nav-link text-white" href="<?=base_url('account/signup');?>">Pruébalo ahora</a>
                  </li>
                </ul>
            </form>
            <?php endif; ?>
      ...
      <div class="container mt-4 mb-3 pb-1">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12 order-first">
            <center class="text-white titlemod">Revolucionando la forma en que litigas</center>
                        
            <p class="text-white mb-5"> 
            Desarrollamos dos herramientas que revolucionarán la forma en que litigas:<br>
            
            <b>1.</b> Un buscador real de sentencias:<br>
            &emsp;Conoce lo que los jueces y las juezas han dicho en casos como el tuyo y utiliza sus propios argumentos a tu favor. Puedes buscar cualquier palabra o frase.  Si están en una sentencia pública, aquí las vas a encontrar. <br>
            
            <b>2.</b> Calculadora de términos: <br>
            &emsp;Deja de contar cuándo vencen tus plazos a mano. Nuestra calculadora lo hace por ti. Ahórrate tiempo y elimina el margen de error. ¡Nunca más fuera de plazo!<br><br><br>
            
            Pruébalo gratis por 30 días, y después solo paga $999.00 MXN pesos al mes. Y puedes cancelar tu suscripción cuando quieras.
            
            </p>
            <center><a class="btn lk-btn btn-primary" href="<?=base_url('account/signup');?>">¡Inscríbete ahora!</a></center>
          </div>
          <div class="col-md-6 col-sm-12 order-last">
            <svg width='555' height='280' viewBox='0 0 355 150' fill='none' xmlns='http://www.w3.org/2000/svg' style='width: 100%;'>
              <g id='lawkit-logo'>
    ...
    <footer class="mt-auto py-3 my-5">
        <!--<ul class="nav justify-content-center border-bottom pb-3 mb-3">
            <li class="nav-item"><a href="mailto:hola@lawkit.mx" class="nav-link px-2 text-dark">Contáctanos aquí</a></li>
        </ul>-->
        <p class="text-center text-dark">© 2023 Lawkit</p>
    </footer>
